...
public class MainActivity extends ActionBarActivity implements BluetoothAdapter.LeScanCallback, MyoGestureListener {
...
//                Log.d("Menu","Select Menu B");
    ...
    public void onClickSave(View v) {
        /*
        byte[] emg = mMyoCallback.getEmgByteDatas();
        byte[] imu = mMyoCallback.getImuByteDatas();
    ...
    public void onClickDetect(View v) {
        ...
        if (saveMethod.getSaveState() == GestureSaveMethod.SaveState.Have_Saved) {
            ...
            detectMethod = new GestureDetectMethod();
                    //new GestureDetectMethod(saveMethod.getCompareDataList());
            detectMethod.setListener(this);
            detectModel = new GestureDetectModel(detectMethod);
            startDetectModel();
        }*/
    ...
    public void onMyoGesture(MyoGesture gesture) {
        Log.i(TAG, "onMyoGesture called. " + gesture.name());
    }
}
